...
\figura{./imagens/gwm_git.png}{12cm}{Interface do repositório Open-Source.}{figura:Godot_with_me_git }

%\figura{caminho}{tamanho cm}{legenda}{referencia}
\figura{./imagens/gwm_ytb.png}{12cm}{Interface do canal no YouTube.}{figura:Godot_with_me_youtube }
...
%\figura{caminho}{tamanho cm}{legenda}{referencia}
\figura{./imagens/lucas_chess.png}{12cm}{Interface do site Lucas Chess.}{figura:lucas_chess}
...
%\figura{caminho}{tamanho cm}{legenda}{referencia}
\figura{./imagens/chess.png}{12cm}{Interface do site Chess.com.}{figura:chess}
